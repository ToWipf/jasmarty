...
//			return new byte[] { (byte) 0x69, (byte) 0x59, (byte) 0x49, (byte) 0x4D, (byte) 0x4B }; // 
	...
	private byte[] getChar68(char c) {
		...
		case 'ä':
		case 'Ä':
			return new byte[] { (byte) 0x20, (byte) 0x75, (byte) 0x54, (byte) 0x54, (byte) 0x7d, (byte) 0x78 }; // ä
		case 'ö':
		case 'Ö':
			return new byte[] { (byte) 0x38, (byte) 0x7D, (byte) 0x44, (byte) 0x44, (byte) 0x7D, (byte) 0x38 }; // ö
		case 'ü':
		case 'Ü':
			return new byte[] { (byte) 0x3C, (byte) 0x7D, (byte) 0x40, (byte) 0x40, (byte) 0x7D, (byte) 0x7C }; // ü
		default:
			return null;
		}
	}
