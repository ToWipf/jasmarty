...
public class ConnectFour {
	...
	public static void start4(Integer nInput) {
		...
		sb.append(("Use 0-" + (width - 1) + " to choose a column"));
		...
		for (int player = 0; moves-- > 0; player = 1 - player) {
			...
			board.chooseAndDrop(symbol, nInput);
		...
		sb.append("Game over. No winner. Try again!");
	}
